...
export const SearchModal = () => {
  ...
  // TODO: Replace this with actual RTK Query hook later when integrating User API
  ...
  // Instant filter logic (Added optional chaining ? for tagline just in case backend doesn't send it)
              ...
              <div className="max-h-[60vh] overflow-y-auto p-4 flex flex-col gap-2 bg-gray-50/50">
                {filteredProducts.length > 0 ? (
                  filteredProducts.map((product) => (
                    <div 
                      key={product._id} // 👈 Updated to _id
                      onClick={() => handleSelectProduct(product._id)} // 👈 Updated to _id
